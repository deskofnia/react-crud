...
function authDefaults(definition) {
    return (0, util_1.query)(["$.components.securitySchemes..['x-default']^"], definition).map(function (res) { return res.pointer; });
}
...
function customCodeSamples(definition) {
    return (0, util_1.query)(["$..['x-code-samples']", "$..['x-readme']['code-samples']"], definition)
        ...
        .map(function (res) { return res.pointer; });
}
...
function rawBody(definition) {
    return (0, util_1.query)(['$..RAW_BODY^^'], definition).map(function (res) { return res.pointer; });
}
